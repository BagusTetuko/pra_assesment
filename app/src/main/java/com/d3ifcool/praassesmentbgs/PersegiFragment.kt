...
import com.d3ifcool.praassesmentbgs.databinding.FragmentPersegiBinding
...
class PersegiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_persegi, container, false)
        ...
        binding.Hitung.setOnClickListener {
            if (binding.Panjang.text.toString().isEmpty() || binding.Lebar.text.toString().isEmpty()) {
                Toast.makeText(this.activity, "This Field Can't empty!!", Toast.LENGTH_SHORT)
                    .show()
            } else {
